...
from app.basic_services import basic_add_card, basic_reactivate_card, basic_remove_card
...
foundation_delete_schema = Schema(
    {Required("id"): int, Required("payment_token"): All(str, Length(min=1)), Optional("status_map"): dict}
)
