...
from metis.agents.spreedly import Spreedly
from metis.services import create_receiver, create_sftp_receiver, send_request
...
class TestServices(unittest.TestCase):
    ...
    def test_spreedly_save(self):
      ...
      <transaction>
        ...
        # comment prevents flake8 checking the previous string.
